                ...
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-arrow">
                      ...
                      <a href="./farmer-cropinfo" class="dropdown-item active"><i class="fe fe-activity"></i> Crop Information</a>
                    </div>
                  </li>
                  <li class="nav-item">
              ...
              <div class="col-md-3">
                ...
                <div>
                  <div class="list-group list-group-transparent mb-0">
                    ...
                    <a href="./resources" class="list-group-item list-group-item-action d-flex align-items-center active">
              ...
              <div class="col-md-9">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Crop/Soil Management Resources</h3>
                  </div>
                  <div class="card-body">
                    <div class="row">
                      <div class="col-lg-6 col-md-6">
                        <h3>Crop Management Resources</h3>
                      </div>
                      <div class="col-lg-6 col-md-6">
                        <h3>Soil Management Resources</h3>
                      </div>
                    </div>
                  </div>
                </div>
