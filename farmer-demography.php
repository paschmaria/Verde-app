                ...
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-arrow">
                      ...
                      <a href="./farmer-demography" class="dropdown-item active"><i class="fe fe-bar-chart-2"></i> Demographics</a>
          ...
          <div class="container">
            ...
            <div class="row row-card row-deck">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="dimmer active">
                      <div class="loader"></div>
                      <div class="dimmer-content">
                        <canvas id="genderChart" style="height: 25rem;"></canvas>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-xl-4 col-md-6">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Distribution by Age</h3>
                  </div>
                  <div class="card-body">
                    <div class="dimmer active">
                      <div class="loader"></div>
                      <div class="dimmer-content">
                        <canvas id="ageChart" style="height: 25rem;"></canvas>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-xl-4 col-md-6">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Distribution by Land Area</h3>
                  </div>
                  <div class="card-body">
                    <div class="dimmer active">
                      <div class="loader"></div>
                      <div class="dimmer-content">
                        <canvas id="landChart" style="height: 25rem;"></canvas>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-xl-4 col-md-6">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Distribution by Education Level</h3>
                  </div>
                  <div class="card-body">
                    <div class="dimmer active">
                      <div class="loader"></div>
                      <div class="dimmer-content">
                        <canvas id="eduChart" style="height: 25rem;"></canvas>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-xl-4 col-md-6">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Distribution by Household Size</h3>
                  </div>
                  <div class="card-body">
                    <div class="dimmer active">
                      <div class="loader"></div>
                      <div class="dimmer-content">
                        <canvas id="houseChart" style="height: 25rem;"></canvas>
                      </div>
                    </div>
                  </div>
                </div>
